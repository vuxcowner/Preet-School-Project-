        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8">
          ...
          <div className="glass-effect neon-border rounded-2xl p-8 hover-glow transition-all duration-300">
            <div className="flex items-center mb-6">
              <Monitor className="w-16 h-16 text-electric-blue mr-4" />
          ...
          <div className="glass-effect neon-border rounded-2xl p-8 hover-glow transition-all duration-300">
            <div className="flex items-center mb-6">
              <BookOpen className="w-16 h-16 text-neon-purple mr-4" />
          ...
          <div className="glass-effect neon-border rounded-2xl p-8 hover-glow transition-all duration-300">
            <div className="flex items-center mb-6">
              <Computer className="w-16 h-16 text-neon-cyan mr-4" />
          ...
          <div className="glass-effect neon-border rounded-2xl p-8 hover-glow transition-all duration-300">
            <div className="flex items-center mb-6">
              <Activity className="w-16 h-16 text-electric-blue mr-4" />
        ...
        <div className="mt-16">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="glass-effect neon-border rounded-xl p-6 text-center hover-glow transition-all duration-300">
              <FlaskConical className="w-12 h-12 text-electric-blue mb-4 mx-auto" />
              <h4 className="font-semibold text-white">Science Labs</h4>
              <p className="text-gray-300 text-xs mt-2">Physics, Chemistry & Biology</p>
            </div>
            <div className="glass-effect neon-border rounded-xl p-6 text-center hover-glow transition-all duration-300">
              <Music className="w-12 h-12 text-neon-purple mb-4 mx-auto" />
              <h4 className="font-semibold text-white">Music Room</h4>
              <p className="text-gray-300 text-xs mt-2">Cultural Activities</p>
            </div>
            <div className="glass-effect neon-border rounded-xl p-6 text-center hover-glow transition-all duration-300">
              <Utensils className="w-12 h-12 text-neon-cyan mb-4 mx-auto" />
              <h4 className="font-semibold text-white">Cafeteria</h4>
              <p className="text-gray-300 text-xs mt-2">Nutritious Meals</p>
            </div>
            <div className="glass-effect neon-border rounded-xl p-6 text-center hover-glow transition-all duration-300">
              <Bus className="w-12 h-12 text-electric-blue mb-4 mx-auto" />
              <h4 className="font-semibold text-white">Transport</h4>
              <p className="text-gray-300 text-xs mt-2">Safe Commuting</p>
            </div>
          </div>
        </div>
      </div>
