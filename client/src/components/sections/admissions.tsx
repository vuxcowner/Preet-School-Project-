    ...
    >
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-300 mt-4 text-lg">Admissions Open for Academic Session 2024-25</p>
        </div>
        
        <div className="grid md:grid-cols-2 gap-12">
          {/* Admission Process */}
          <div className="glass-effect neon-border rounded-2xl p-8 hover-glow transition-all duration-300">
            <h3 className="font-orbitron text-2xl font-semibold mb-6 text-electric-blue">Admission Process</h3>
          ...
          <div className="space-y-8">
            <div className="glass-effect neon-border rounded-2xl p-8 hover-glow transition-all duration-300">
              <h3 className="font-orbitron text-2xl font-semibold mb-6 text-neon-cyan">Required Documents</h3>
            ...
            <div className="glass-effect neon-border rounded-2xl p-8 hover-glow transition-all duration-300">
              <h3 className="font-orbitron text-xl font-semibold mb-4 text-neon-purple">Important Dates</h3>
              <div className="space-y-3">
                <div className="flex justify-between items-center text-sm">
                  <span className="text-gray-300">Admission Form Available:</span>
                  <span className="text-electric-blue">February 1, 2024</span>
                </div>
                <div className="flex justify-between items-center text-sm">
                  <span className="text-gray-300">Last Date for Submission:</span>
                  <span className="text-neon-purple">March 15, 2024</span>
                </div>
                <div className="flex justify-between items-center text-sm">
                  <span className="text-gray-300">Assessment Period:</span>
                  <span className="text-neon-cyan">March 20-25, 2024</span>
                </div>
                <div className="flex justify-between items-center text-sm">
                  <span className="text-gray-300">Admission Confirmation:</span>
                  <span className="text-electric-blue">March 30, 2024</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="text-center mt-12">
          <button 
            ...
            className="bg-gradient-to-r from-electric-blue to-neon-purple text-white font-semibold px-8 py-4 rounded-full hover-glow transition-all duration-300"
